<div align="center">
<img alt="Logo" src="../images/amecs-logo-128.png" />
...
A Minecraft Fabric mod that allows adding key modifiers (e.g. shift or control) to every keybinding
...
This is especially useful in conjunction with a large number of mods, so you don't need to find that one obscure key on your keyboard that isn't in use yet.
